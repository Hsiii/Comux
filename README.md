...
<div align="center">
  ...
  <img src="https://raw.githubusercontent.com/sago-cream/comux/main/assets/demo.png" alt="Comux menu bar usage demo" width="420" />

  <a href="https://github.com/sago-cream/comux/releases/latest">Download latest release</a>
   ·
...
Or download from [GitHub Releases](https://github.com/sago-cream/comux/releases/latest).
...
If Comux does not show an account, open Codex and confirm that account is signed in locally, then reopen the Comux menu. If Homebrew installs an older version, use **Check for Updates** from the Comux menu or run `brew update` and then `brew upgrade --cask sago-cream/tap/comux`.
